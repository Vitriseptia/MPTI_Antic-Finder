                        ...
                        <div class="d-flex m-3 me-0 align-items-center">
                            ...
                            <?php
                                if (!isset($_SESSION['id'])) {
                                    echo '<button type="button" class="btn btn-primary"><a href="login.php" style="color: white; text-decoration: none;">Login</a></a></button>';
                                }else{
                                ...
                                <a class="nav-link dropdown-toggle rounded-bottom rounded-top border border-secondary href="#" id="userDropdown" role="button"
                                    ...
                                    <span class="mr-2 d-none d-lg-inline text-gray-600 small me-2">'. $namaUser  .'</span>
            ...
            <div class="modal-dialog modal-fullscreen">
                <div class="modal-content rounded-0">
                    ...
                    <div class="modal-body d-flex align-items-center">
                        <form action="index.php" method="post" class="w-75 mx-auto d-flex">
                            <div class="input-group">
                                <input type="search" name="search_keyword" class="form-control p-3" placeholder="keywords" aria-describedby="search-icon-1">
                                <button name="search" type="submit" class="input-group-text p-3" id="search-icon-1"><i class="fa fa-search"></i></button>
                            </div>
                        </form>
                    </div>
                </div>
                                                ...
                                                <div class="rounded position-relative fruite-item d-flex flex-column">
                                                    ...
                                                    <div class="d-flex flex-column justify-content-between p-4 border border-secondary border-top-0 rounded-bottom" style="flex-grow: 1;">
                                                        ...
                                                        <div class="d-flex flex-column justify-content-center flex-lg-wrap">
                                                            ...
                                                            if (isset($_SESSION['id'])) {
                                                                echo '<a href="detail.php?id=' . $data['id'] . '" class="btn border border-secondary rounded-pill px-3 text-primary"><i class="fa fa-shopping-bag me-2 text-primary"></i> Buy Now</a>';
                                                            }else{
                                                                echo '<a href="login.php" class="btn border border-secondary rounded-pill px-3 text-primary"><i class="fa fa-shopping-bag me-2 text-primary"></i> Buy Now</a>';
                                                            }
                                                        echo '</div>
                                                    </div>
                                                </div>
