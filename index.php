...
<html lang="en">
    ...
    <body>
                            ...
                            <ul class="nav nav-pills d-inline-flex text-center mb-5">
                                ...
                                <li class="nav-item">
                                    <a class="d-flex m-2 py-2 bg-light rounded-pill" data-bs-toggle="pill" href="#tab-3">
                                        <span class="text-dark" style="width: 130px;">Furniture</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                                        ...
                                        foreach($result as $data){
                                            ...
                                            echo '<div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="rounded position-relative fruite-item d-flex flex-column">
                                                    ...
                                                    if ($data['jenis'] == 'elektronik') {
                                                        echo 'Elektronik';
                                                    } elseif ($data['jenis'] == 'furniture') {
                                                        echo 'Furniture';
                                                    }
                                                    echo '</div>
                        ...
                        <div id="tab-2" class="tab-pane fade show p-0">
                            <div class="row g-4">
                                <div class="col-lg-12">
                                    ...
                                    <?php
                                        $sql = "SELECT * FROM barang WHERE jenis = 'elektronik'";
                                        $result = $connection->query($sql);
                                        $result->execute();
                                        foreach($result as $data){
                                            $idData = $data['id'];
                                            ...
                                            echo '<div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="rounded position-relative fruite-item d-flex flex-column">
                                                    <div class="fruite-img" style="height: 16rem;">
                                                        <img src="'. $gambarData . '" class="img-fluid w-100 rounded-top" style="object-fit: cover;" alt="">
                                                    </div>
                                                    <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">Elektronik</div>
                                                    <div class="d-flex flex-column justify-content-between p-4 border border-secondary border-top-0 rounded-bottom" style="flex-grow: 1;">
                                                        <div>
                                                            <h4>'. $namaData .'</h4>
                                                            <p>'. $deskripsiData .'</p>
                        ...
                        <div id="tab-3" class="tab-pane fade show p-0">
                            <div class="row g-4">
                                <div class="col-lg-12">
                                    ...
                                    <?php
                                        $sql = "SELECT * FROM barang WHERE jenis = 'furniture'";
                                        $result = $connection->query($sql);
                                        $result->execute();
                                        foreach($result as $data){
                                            $idData = $data['id'];
                                            ...
                                            echo '<div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="rounded position-relative fruite-item d-flex flex-column">
                                                    ...
                                                    <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">Furniture</div>
                                                    <div class="d-flex flex-column justify-content-between p-4 border border-secondary border-top-0 rounded-bottom" style="flex-grow: 1;">
                                                        <div>
                                                            <h4>'. $namaData .'</h4>
                                                            <p>'. $deskripsiData .'</p>
        ...
        <!-- Tastimonial Start -->
        <div id="testimonials" class="container-fluid testimonial py-5">
            <div class="container py-5">
                ...
                <div class="row g-5 justify-content-between">
                    <div class="col-lg-3 col-md-6">
                        <div class="d-flex flex-column text-start footer-item">
                            ...
                            <a class="btn-link" href="">Testimonials</a>
